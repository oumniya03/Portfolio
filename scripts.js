const projectsData = [
    ...
    },
    {
        ...
        tags: ["MLflow", "Kubernetes","CI/CD", "FastAPI", "Docker", "SVD", "Prometheus", "Grafana"],
...
// Configuration de l'animation de fond (Réseau de neurones)
if (typeof particlesJS !== 'undefined') {
    particlesJS('particles-js', {
      "particles": {
        "number": { "value": 60, "density": { "enable": true, "value_area": 800 } },
        "color": { "value": "#0ea5e9" }, // Couleur Sky-500
        "shape": { "type": "circle" },
        ...
        "move": {
          "enable": true,
          "speed": 2, // Vitesse lente et élégante
          "direction": "none",
          "random": false,
          "straight": false,
          "out_mode": "out",
      ...
      "interactivity": {
        "detect_on": "canvas",
        "events": {
          "onhover": { "enable": true, "mode": "grab" }, // Les lignes se connectent à la souris
